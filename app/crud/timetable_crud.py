...
def get_timetables(*, session: Session, skip: int = 0, limit: int = 100) -> tuple[list[Timetable], int]:
...
def update_timetable(*, session: Session, db_item: Timetable, item_update: TimetableUpdate) -> Timetable:
