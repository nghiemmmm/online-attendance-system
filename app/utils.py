...
EmailData: cấu trúc chứa subject và html_content của email.
render_email_template(): đọc file HTML trong build rồi thay biến bằng Jinja2.
send_email(): gửi email qua SMTP, lấy cấu hình từ settings.
generate_test_email(): tạo email test.
generate_reset_password_email(): tạo email quên mật khẩu, có link reset.
