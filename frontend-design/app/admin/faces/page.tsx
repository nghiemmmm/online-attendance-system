...
const studentFaces: StudentFace[] = [
...
export default function AdminFaceManagement() {
  ...
  const filteredStudents = studentFaces.filter((student) => {
          ...
          <div className="w-[400px] bg-white border border-[#E2E8F0] rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-4 space-y-6">
              ...
              <div>
                ...
                <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-[#E2E8F0] rounded-lg cursor-pointer hover:bg-[#F8FAFC] transition-colors">
                  <Upload className="w-6 h-6 text-[#64748B] mb-1" />
                  <span className="text-xs text-[#64748B]">
                    Kéo thả ảnh chân dung rõ mặt
                  </span>
